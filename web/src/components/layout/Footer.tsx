          ...
          <div className="sm:col-span-2 md:col-span-3 lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-3 mb-6 group">
              ...
              <span className="font-bold text-xl text-white tracking-tight">
                TERENCE <span className="text-cyan-400">EĞİTİM</span>
              </span>
            </Link>
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <Mail className="w-4 h-4 text-cyan-400/80 group-hover:text-cyan-400" />
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-slate-400 hover:text-cyan-400 transition-colors text-sm group"
              >
                <Phone className="w-4 h-4 text-cyan-400/80 group-hover:text-cyan-400" />
                0850 123 45 67
              </a>
            </div>
          </div>
            ...
            <ul className="space-y-3.5">
              {footerLinks.platform.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="inline-flex items-center gap-1.5 text-slate-400 hover:text-cyan-400 transition-colors text-sm group"
                  >
                    {link.label}
