    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-xl border-b border-slate-200/60">
      <div className="max-w-7xl mx-auto px-3 min-[400px]:px-4 sm:px-6 lg:px-8 min-w-0">
        <div className="flex items-center justify-between h-16 lg:h-20 gap-2 min-w-0">
          ...
          <Link
            href="/"
            className="flex items-center gap-2 sm:gap-3 text-slate-900 hover:opacity-90 transition-opacity group min-w-0 shrink"
          >
            <Image src="/logo.png" alt="Terence Eğitim" width={44} height={44} className="rounded-2xl shrink-0 size-9 sm:size-11" />
            <span className="font-bold text-base min-[400px]:text-lg sm:text-xl tracking-tight truncate">
              TERENCE{" "}
