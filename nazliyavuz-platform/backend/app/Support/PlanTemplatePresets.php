 ...
 */
final class PlanTemplatePresets
{
    /**
     * @return array<int, array{key: string, label: string, description: string, tasks: array<int, array<string, mixed>>}>
     */
    ...
    private static function yksPack(): array
    {
        return [
            [
                'key' => 'yks_tyt_block',
    ...
    private static function primaryPack(): array
    {
        return [
            [
